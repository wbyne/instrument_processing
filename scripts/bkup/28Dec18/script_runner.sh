...
process_all_data.pl 
# this was a fork of process_texts.pl and it is used to create three files:
#    1. data/station/ALLDATA/station_reset.csv, which shows all resets in the screenlog file
#    2. data/site/ALLDATA/ALLDATA.csv, a summary of all data in a csv file
#    3. data/site/ALLDATA/ALLDATA_Summary.csv, for only a select few parameters
