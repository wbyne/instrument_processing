...
my $tmpmon = $mon+1;
       ...
       for $ii (0 ..$#stationlist) {
         if ($ii==0) {print STATS_FILE "STATION 1 (Frontage Rd)\n";}
         if ($ii==1) {print STATS_FILE "STATION 2 (Bertram Rd)\n";}
         if ($ii==2) {print STATS_FILE "STATION 3 (Berckman Rd)\n";}
         if ($ii==3) {print STATS_FILE "STATION 4 (Jamestown Comm Ctr)\n";}
         if ($ii==4) {print STATS_FILE "STATION 5 (East Aug Pond)\n";}
         if ($ii==5) {print STATS_FILE "STATION 6 (Oates Cr)\n";}
         if ($ii==6) {print STATS_FILE "STATION 7 (3rd Level/Twiggs)\n";}
         if ($ii==7) {print STATS_FILE "STATION 8 (Spirit Creek/Goshen)\n";}
         if ($ii==8) {print STATS_FILE "STATION 9 (Crane/Merrick)\n";}
         if ($ii==9) {print STATS_FILE "STATION 10 (Rock/St Crk Rd)\n";}
         if ($ii==10) {print STATS_FILE "STATION 11 (Butler at Phinizy)\n";}
         if ($ii==11) {print STATS_FILE "STATION 12 (Aug Univ)\n";}
         for $jj (0 ..$#paramlist) {
...
print TABLE_FILE "<!DOCTYPE html>\n<html>\n<head>\n<style>\ntable {\n    font-family: arial, sans-serif;\n    border-collapse: collapse;\n    width: 100%;\n}\n\ntd, th {\n     border: 1px solid #dddddd;\n    text-align: center;\n    padding: 8px;\n}\n\ntr:nth-child(even) {\n    background-color: #dddddd;\n\n}</style>\n</head>\n<body>\n";
	   ...
	   if ($ii==9) {
         ...
         if ($ii==1) {
	     $mystatno = " 2 (Bertram Rd)";
	 }
         if ($ii==0) {
	     $headerstring = "<tr><th colspan=\"18\">RAE'S and CRANE CREEK</tr>\n";
	     print TABLE_FILE $headerstring;
	     $mystatno = " 1 (Frontage Rd)";
	 }
         if ($ii==8) {
	     $mystatno = " 9 (Crane at Merrick)";
	 }
         if ($ii==2) {
	     $mystatno = " 3 (Berckman)";
	 }
         if ($ii==11) {
	     $mystatno = "12 (Aug Univ)";
	 }
         if ($ii==6) {
	     $headerstring = "<tr><th colspan=\"18\">DOWNTOWN and EAST AUGUSTA</tr>\n";
	     print TABLE_FILE $headerstring;
	     $mystatno = " 7 (3rd Level at Twiggs)";
	 }
         if ($ii==4) {
	     $mystatno = " 5 (East Augusta Pond)";
	 }
         if ($ii==5) {
	     ...
	     print TABLE_FILE $headerstring;
	     $mystatno = "11 (Phinizy Boardwalk)";
	 }
         if ($ii==3) {
	     $headerstring = "<tr>\n<th colspan=\"18\">SPIRIT CREEK</tr>\n";
	     print TABLE_FILE $headerstring;
	     $mystatno = " 4 (Jamestown Comm Ctr)";
	 }
         if ($ii==7) {
	     $mystatno = " 8 (Goshen Rd)";
	 }
