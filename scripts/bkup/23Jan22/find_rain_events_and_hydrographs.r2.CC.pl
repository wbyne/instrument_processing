...
for $ii (0 ..$#stationlist) {
    ...
    #next section should get rid of year 00 dates, misc +CMT records, etc. and save in a clean file
...
for $ii (0 ..$#stationlist) {
	...
	#$kk = 0;
	$ll = 0;
	open (INPUT_FILE,">", "$savepath/$stationlist[$ii]/ALLDATA/$stationlist[$ii]_ALLDATA_hydrographs_hyetographs.csv") or die "Can\'t find INPUT_FILE\n";
