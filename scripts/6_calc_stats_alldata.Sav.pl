...
my @stationlist = qw(5000 5100 5200 5500); # 3300 3400 3500 3600 5100 5200 5300 5500 5900);
...
my $tmpmon = $mon+1;
       ...
       for $ii (0 ..$#stationlist) {
         if ($ii==0) {print STATS_FILE "STATION 5000 Harmon Creek\n";}
         if ($ii==1) {print STATS_FILE "STATION 5100 Vernon River\n";}
         if ($ii==2) {print STATS_FILE "STATION 5200 Casey Canal\n";}
         if ($ii==3) {print STATS_FILE "STATION 5500 Vernon River Ultrasonic\n";}
...
#55: Mobile Station
####
my @orderedstationlist = qw(5000 5100 5200 5500);
...
print TABLE_FILE "<!DOCTYPE html>\n<html>\n<head>\n<style>\ntable {\n    font-family: arial, sans-serif;\n    border-collapse: collapse;\n    width: 100%;\n}\n\ntd, th {\n     border: 1px solid #dddddd;\n    text-align: center;\n    padding: 8px;\n}\n\ntr:nth-child(even) {\n    background-color: #dddddd;\n\n}</style>\n</head>\n<body>\n";
	 ...
	 if ($ii==5000) {
	   $headerstring = "<tr><th colspan=\"18\">VERNON RIVER</tr>\n";
	     ...
	     $mystatno = "5000: Harmon Creek";
	 }			
         if ($ii==5100) {
	     $mystatno = "5100: Vernon River";
	 }
         if ($ii==5200) {
	     $mystatno = "5200: Casey Canal";
	 }
         if ($ii==5500) {
	     $mystatno = "5500: Vernon River Ultrasonic";
	 }
